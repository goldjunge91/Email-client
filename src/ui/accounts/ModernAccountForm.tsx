...
import { 
  Mail, Lock, Server, Globe, Shield, AlertCircle, 
  CheckCircle, Loader2, Eye, EyeOff, HelpCircle,
  Zap, Info
} from 'lucide-react';
...
export default function ModernAccountForm({ onClose, onSave }: { onClose: () => void; onSave: (data: AccountFormData) => void }) {
  ...
  const [activeTab, setActiveTab] = useState<'basic' | 'incoming' | 'outgoing'>('basic');
  ...
  const handleSecurityChange = (type: 'incoming' | 'outgoing', security: 'none' | 'ssl' | 'starttls') => {
    if (type === 'incoming') {
  ...
  const handleVerify = async () => {
    ...
    try {
      ...
      setVerificationMessage('Failed to verify account. Please check your settings.');
    } finally {
          ...
          <div className="p-6 space-y-6">
            ...
            {activeTab === 'basic' && (
              <div className="space-y-6">
                {/* Quick Setup */}
                <div>
                  <h3 className="text-sm font-medium text-zinc-300 mb-3">Quick Setup</h3>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        onChange={(e) => setFormData(prev => ({ 
                          ...
                          outgoingUsername: prev.useIncomingCredentials ? e.target.value : prev.outgoingUsername
                        }))}
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        onChange={(e) => setFormData(prev => ({ 
                          ...
                          outgoingPassword: prev.useIncomingCredentials ? e.target.value : prev.outgoingPassword
                        }))}
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <div className="flex gap-3">
                    <button
                      type="button"
                      onClick={() => setFormData(prev => ({ ...prev, incomingProtocol: 'imap' }))}
                    ...
                    <button
                      type="button"
                      onClick={() => setFormData(prev => ({ ...prev, incomingProtocol: 'pop3' }))}
                      className={`flex-1 py-2 px-4 rounded-lg transition-colors ${
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      onChange={(e) => setFormData(prev => ({ ...prev, incomingHost: e.target.value }))}
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => setFormData(prev => ({ ...prev, incomingPort: parseInt(e.target.value) }))}
                      className="w-full px-3 py-2 bg-zinc-800 rounded-lg text-sm placeholder-zinc-500 focus:outline-none focus:ring-2 focus:ring-blue-500/50"
                      required
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={(e) => handleSecurityChange('incoming', e.target.value as any)}
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => setFormData(prev => ({ ...prev, incomingUsername: e.target.value }))}
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      onChange={(e) => setFormData(prev => ({ ...prev, outgoingHost: e.target.value }))}
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => setFormData(prev => ({ ...prev, outgoingPort: parseInt(e.target.value) }))}
                      className="w-full px-3 py-2 bg-zinc-800 rounded-lg text-sm placeholder-zinc-500 focus:outline-none focus:ring-2 focus:ring-blue-500/50"
                      required
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={(e) => handleSecurityChange('outgoing', e.target.value as any)}
                      className="w-full px-3 py-2 bg-zinc-800 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/50"
                    >
                      <option value="none">None</option>
                      <option value="ssl">SSL/TLS</option>
                  ...
                  <label className="flex items-center gap-3 cursor-pointer">
                    <input
                      ...
                      onChange={(e) => setFormData(prev => ({ 
                        ...
                        outgoingUsername: e.target.checked ? prev.incomingUsername : prev.outgoingUsername,
                        outgoingPassword: e.target.checked ? prev.incomingPassword : prev.outgoingPassword
                      }))}
                      className="w-4 h-4 rounded bg-zinc-700 border-zinc-600 text-blue-600 focus:ring-blue-500/50"
                    />
                    <span className="text-sm">Use same credentials as incoming server</span>
                  </label>
                </div>
                  ...
                  <>
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) => setFormData(prev => ({ ...prev, outgoingUsername: e.target.value }))}
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          onChange={(e) => setFormData(prev => ({ ...prev, outgoingPassword: e.target.value }))}
                        ...
                        <button
                          type="button"
                          onClick={() => setShowOutgoingPassword(!showOutgoingPassword)}
                          className="absolute right-3 top-1/2 -translate-y-1/2 text-zinc-500 hover:text-zinc-300"
                        >
                          {showOutgoingPassword ? <EyeOff className="w-4 h-4" /> : <Eye className="w-4 h-4" />}
                        </button>
                      </div>
                    </div>
                  </>
            ...
            {verificationStatus !== 'idle' && (
              <div className={`p-4 rounded-lg flex items-center gap-3 ${
                verificationStatus === 'success' ? 'bg-green-900/20 text-green-400' : 'bg-red-900/20 text-red-400'
              }`}>
